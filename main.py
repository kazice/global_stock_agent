...
SECTORS = [
    ...
    (241, 250, "电气设备"),         # 10支: 施耐德电气~正泰电器
    (251, 259, "工程机械"),         # 9支: 卡特彼勒~阿特拉斯科普柯
    (260, 268, "化工"),             # 9支: 陶氏~阿克苏诺贝尔
    (269, 277, "物流/运输"),        # 9支: UPS~商船三井
    (278, 282, "消费"),             # 5支: LVMH~耐克
    (283, 294, "必需消费"),         # 12支: 可口可乐~家得宝
    (295, 301, "矿业"),             # 7支: 必和必拓~紫金矿业
    (302, 306, "保险"),             # 5支: 中国平安~保诚
]
