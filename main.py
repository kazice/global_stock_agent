...
def route_symbol(symbol: str) -> str:
    ...
    m = {"TW":"twse","TWO":"twse","T":"stooq","KS":"stooq",
...
FALLBACK_CHAIN = {"twse":["twstock","stooq","yahoo"],"twstock":["stooq","yahoo"],"jquants":["yahoo"],"akshare":["stooq","yahoo"],"hk":["stooq","yahoo"],"finnhub":["stooq","yahoo"],"stooq":["jquants","yahoo"]}
# ============================================================
