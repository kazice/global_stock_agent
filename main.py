...
FALLBACK_CHAIN = {"twse":["twstock","stooq","yahoo"],"twstock":["stooq","yahoo"],"jquants":["yahoo"],"akshare":["stooq","yahoo"],"hk":["stooq","yahoo"],"finnhub":["stooq","yahoo"],"stooq":["twse","jquants","yahoo"],"naver":["stooq","yahoo"],"yahoo":["stooq","jquants"]}
# ============================================================
